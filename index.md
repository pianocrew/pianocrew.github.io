本源码来自https://github.com/zobinHuang/zobinhuang.github.io
...
<link rel="canonical" href="https://zobinhuang.github.io/">
...
<!-- <div align="center" style="height: 155px">
    <div class="wrapper">
        <div class="sofa">
...
<!-- <div align="center" class="title">
    <h1>
        <b><font color=#FFFFFF>We chosed to go to the moon</font></b>
    </h1>
</div>
...
<!--周报-->
<!-- 周报部分的 h5 代码被 backup 在 scripts/weekly_backup.html 下 -->

<!-- <div class="main_content_container">
    <div id="recent_post" class="recent_post">
        <h1 style="margin-down=0">最新博文</h1>
        <hr style="margin-top: 0;" align=center width=90% />
        <div class="recent_post_loading_alert" id="recent_post_loading_alert" align="center">
            加载中, 请稍后...
        </div>
        <a href="/sec_learning/Program_Go/index.html">
            <div id="demo5" class="block">
                <div class="block_date">
                    <p><b><i>&nbsp;June.5 2021&nbsp;</i></b></p>
                </div>
                <div style="padding: 20px;">
                    <h1 align="center">📌 Golang 基础圣经正在搬运与更新</h1>
                    <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;工作中碰到一些业务需求需要使用 Golang 作为后台开发语言，以前只有使用 C++ 的经验，故特地花了一些时间熟悉各种 Golang 的特性，并且将社区中的一些中文参考材料进行了搬运和整理，并且加上了一些我的使用经验，在此进行分享，欢迎评论！感谢为社区贡献攥写入门参考的前辈。
                    <br>
                </div>
            </div>
        </a>
